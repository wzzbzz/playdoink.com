class Room {
    ...
    constructor(name, canvasId, containerId) { 
        this.name = name;
...
document.querySelectorAll(".menu-item").forEach(item => {
    item.addEventListener("click", () => {
        console.log(item.textContent, activeTarget);
        ...
        if (item.textContent === "Spectate" && activeTarget) {

            loadGame('spectator', { target: activeTarget.name });   // instead of startGame()
